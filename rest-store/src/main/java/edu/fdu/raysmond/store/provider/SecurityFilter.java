...
//
//		// User customer = new User("user", UserRole.CUSTOMER);
//
...
//		// user = new User("user", UserRole.CUSTOMER);
//		// System.out.println("USER AUTHENTICATED");
//		// } else if (username.equals("admin") && password.equals("admin")) {
//		// user = new User("admin", UserRole.MANAGER);
//		// System.out.println("ADMIN AUTHENTICATED");
//		edu.fdu.raysmond.store.entity.User u = UserController.getUserByName(username);
//		if (u != null && Encryption.MD5(password).equals(u.getPassword())) {
//			user = new User(u.getName(), u.getRole());
//		} else {
